...
#if HDMI_SUB_PATH_SUPPORT_DL_DC_DYNAMIC_SWITCH
EXT_DISP_PATH_MODE hdmi_ext_disp_mode = EXTD_DECOUPLE_MODE;
#endif
...
static enum FRC_TYPE get_frc_type(void)
{
	...
	else if ((video_fps > 2300 && video_fps < 2600 && 50 == tv_fps)
		    || (video_fps > 2900 && video_fps < 3100 && 60 == tv_fps))
		frc_type = FRC_1_TO_2_MODE; /* 25->50 / 30->60 */
	else if (video_fps > 2300 && video_fps < 2450 && 60 == tv_fps)
...
{
	rdma_trigger_count++;
	if (rdma_trigger_count >= hdmi_get_tv_fps()) {
